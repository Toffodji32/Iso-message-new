 ...
 */
final class Version20250602095711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE sms_recipient (id INT AUTO_INCREMENT NOT NULL, sms_message_id INT NOT NULL, contact_id INT NOT NULL, delivery_status VARCHAR(255) NOT NULL, error_details LONGTEXT DEFAULT NULL, INDEX IDX_1F653DFE60854C0 (sms_message_id), INDEX IDX_1F653DFEE7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
